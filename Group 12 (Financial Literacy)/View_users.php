...
<body>
    <nav>
        ...
        <a href="indexad.html" class="nav_log"><img src="./images/logo.png" class="avatars" alt="">Financial Literacy 101</a>
            <ul class="nav_items">
...
<section class="dashboard">
    <div class="container dashboard_container">
        ...
        <aside>
            <ul>
                <li>
                    <a href="dashboard.php" class="active"><i class="uil uil-create-dashboard"></i></a>
                    <h5>Edit Posts</h5>
                </li>
                <li>
                    <a href="View_users.php"><i class="uil uil-user-plus"></i></a>
                    <h5>View Users</h5>
                </li>
                <li>
                    <a href="manage_users.php"><i class="uil uil-users-alt"></i></a>
                    <h5>Manage Users</h5>
                </li>
            </ul>
        </aside>
